...
our $execdir = "/psipred-3.5/bin";  # path to PSIPRED V2 binaries
our $datadir = "/psipred-3.5/data_no_dat4"; # path to PSIPRED V2 data files
our $ncbidir = "/usr/bin";    # path to NCBI binaries (for PSIPRED in addss.pl)
